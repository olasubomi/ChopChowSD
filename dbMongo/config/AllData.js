    ...
    const allDataList = [
        {
            ...
            product_image: '../../client/build/images/products/garri.jpg',
            product_price: 8.99,
            sizes: ["50lbs"]
        }, {
            id:2,
            product_name: "Brown Beans",
            product_image: '../../client/build/images/products/beans.jpeg',
            product_price: 12.00,
            sizes: ["2 lbs"],
            price_per_ounce: 3.2
        }, {
        ...
        },
        {
            ...
            product_image: '../../client/build/images/products/blueberries.jpg',
            product_price: 1.00,
            sizes: ["1lbs"]
        },
        {
            ...
            product_image: '../../client/build/images/products/potatoes.jpg',
            product_price: 8.99,
            sizes: ["50lbs"]
        },
        {
