...
const { customer_list } = require("../../config/db_buildSchema");
const { addList } = require("../../dbPostgress/queries/list/addList");
const {
  addListCustomer,
} = require("../../dbPostgress/queries/list/addListCustomer");
module.exports = (req, res) => {
  ...
  var createCustomerList = new customer_list({
    list_id: idItem,
