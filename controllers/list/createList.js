...
module.exports = (req, res) => {
    ...
    if (valueProductImage.startsWith('http://wwww.')) {
        console.log(55555);
        ...
        res.status(400).send('must be  valid image , must end of png or gif or png ');
            }
    } else {
        res.status(400).send('must be  valid image , must start of  http://www.');
